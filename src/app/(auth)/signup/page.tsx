    ...
    <>
      ...
      <form className="space-y-4" action={handleSubmit}>
        ...
        <motion.div custom={3} variants={itemVariants} initial="hidden" animate="visible">
          <label htmlFor="signup-business" className="block text-sm font-medium mb-2">
            Business Name{" "}
        ...
        <motion.div custom={5} variants={itemVariants} initial="hidden" animate="visible" className="flex items-start gap-2">
          ...
          <label htmlFor="terms" className="text-sm text-muted leading-snug">
            I agree to the{" "}
            <Link href="#" className="text-brand-indigo hover:text-brand-purple transition-colors">
              Terms of Service
            </Link>{" "}
            and{" "}
            <Link href="#" className="text-brand-indigo hover:text-brand-purple transition-colors">
        ...
        {/* Divider */}
        <motion.div custom={7} variants={itemVariants} initial="hidden" animate="visible" className="flex items-center gap-4">
